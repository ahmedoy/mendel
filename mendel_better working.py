...
def gen(par1,par2):
    ...
    print('off is ' + str(off))
    print()
    print(off[0])#showing the colour traits remember the X & x refer to colour
    print()
    print(off[1])#showing the length traits  remember the Y & y refer to length
    print()
    print()
...
while True:
    ...
    gen(chosen_z_1,chosen_z_2)


    #deciding trait 1
    print(trait_dic[verdict(0,off)])#running the function that decides whether the offspring has a  dominant colour  trait or not
    print()

    #deciding trait 2   
    print(trait_dic[verdict(1,off)])#running the function that decides whether the offspring has a  dominant length  trait or not
    print()


    #offspring (2) becomes parent
    seg(off)
    list_of_organis.append(z_off)
    list_of_organis_string.append('z_off')

    #now that we have z1,z2,z3,offspring1,offspring2 we can use them to make newer generations for a given number of times
    print("Type the number of generations you want")
    gen_num  = input()
